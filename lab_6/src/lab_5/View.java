...
public class View {
	...
	public int menuChoice() {
		...
		System.out.println("7.Read from file(string).");
		System.out.println("8.Read from file(object).");
		System.out.println("9.Write to file(string).");
		System.out.println("10.Write to file(object).");
		System.out.println("11.Exit.\n");
		
		Scanner scan = new Scanner(System.in);
		String choice;		
		while (true) {
			System.out.print("Choose the option that you need by entering number\"1-11\" and pressing Enter: ");
			choice = scan.nextLine();
	        try {
	        	new IntegerValidator(1, 11).valid(choice);
	            break;
